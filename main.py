...
photologo = 'https://images.app.goo.gl/VviE1WPDzXRB5L9JA'
photoyt = 'https://images.app.goo.gl/VviE1WPDzXRB5L9JA'
photocp = 'https://images.app.goo.gl/VviE1WPDzXRB5L9JA'
...
Busy = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/Meoujkreal"),
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+wuK9V2erXlsyYzg1"),
        ],
    ]
)
...
image_urls = [
    "https://images.app.goo.gl/VviE1WPDzXRB5L9JA",
    "https://images.app.goo.gl/VviE1WPDzXRB5L9JA",
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        "🎉Congrats! You are using Billa x team:\n┣\n"
...
async def txt_handler(bot: Client, m: Message):
    ...
    await m.reply_text(f"`✨𝙱𝚊𝚝𝚌𝚑 𝚂𝚞𝚖𝚖𝚊𝚛𝚢✨\n"
                       ...
                       f"✅𝚂𝚝𝚊𝚝𝚞𝚜 » 𝙲𝚘𝚖𝚙𝚕𝚎𝚝𝚎𝚍`")
    await m.reply_text("<pre><code>Downloaded By ⌈✨『BILLA』✨⌋</code></pre>")
